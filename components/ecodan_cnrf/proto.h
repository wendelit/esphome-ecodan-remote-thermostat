...
namespace ecodan 
{
    ...
    enum class MsgType : uint8_t
    {
        ...
        THERMOSTAT_INITIAL_GET = 0x4C,
        THERMOSTAT_INITIAL_GET_RES = 0x6C,
        THERMOSTAT_HOTWATER_SET_RES = 0x6A,
        THERMOSTAT_HOLIDAY_SET_RES = 0x6B,
        THERMOSTAT_CURRENT_TEMP_SET = 0x48,
        THERMOSTAT_CURRENT_TEMP_SET_RES = 0x68,
        THERMOSTAT_TARGET_TEMP_SET = 0x49,
        THERMOSTAT_TARGET_TEMP_SET_RES = 0x69
    };
...
#define SET_SETTINGS_FLAG_HOLIDAY_MODE_TOGGLE 0x2
    ...
    const uint8_t MAX_REMOTE_THERMOSTATS = 8;
    ...
    struct Message
    {
        ...
        // used for min/max in remmote thermostat
        ...
        void set_float8_v3(float value, size_t index)
        {
            payload()[index] = uint8_t(value * 2 + 128.0f);
        }
